...
// Package tests implements execution of Vapory JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, config, vapash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/vaporyco/tests/wiki/Blockchain-Tests-II
