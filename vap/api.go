// Copyright 2015 The go-vapory Authors
...
// PublicVaporyAPI provides an API to access Vapory full node-related
// information.
...
// PrivateDebugAPI is the collection of Vapory full node APIs exposed over
