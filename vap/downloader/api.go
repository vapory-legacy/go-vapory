...
// Syncing provides information when this nodes starts synchronising with the Vapory network and when it's finished.
...
type SyncingResult struct {
	...
	Status  vapory.SyncProgress `json:"status"`
}
