...
// information related to the Vapory protocol such als blocks, transactions and logs.
...
// `vap_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/vaporyco/wiki/wiki/JSON-RPC#vap_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with vap_getFilterChanges.
//
// https://github.com/vaporyco/wiki/wiki/JSON-RPC#vap_newblockfilter
...
//
// https://github.com/vaporyco/wiki/wiki/JSON-RPC#vap_newfilter
...
//
// https://github.com/vaporyco/wiki/wiki/JSON-RPC#vap_uninstallfilter
...
//
// https://github.com/vaporyco/wiki/wiki/JSON-RPC#vap_getfilterlogs
...
//
// https://github.com/vaporyco/wiki/wiki/JSON-RPC#vap_getfilterchanges
