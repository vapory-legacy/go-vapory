...
func vvmdis_tracerJs() (*asset, error) {
	bytes, err := vvmdis_tracerJsBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "vvmdis_tracer.js", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"vvmdis_tracer.js": vvmdis_tracerJs,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"vvmdis_tracer.js":   {vvmdis_tracerJs, map[string]*bintree{}},
