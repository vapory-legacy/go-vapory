...
// PeerInfo represents a short summary of the Vapory sub-protocol metadata known
...
// Handshake executes the vap protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("vap/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Vapory sub-protocol.
type peerSet struct {
