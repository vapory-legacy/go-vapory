...
# 1. install gvap for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gvap
# 5. create gvap, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable VAPORY_SOCKET
...
!define GROUPNAME "Vapory"
!define APPNAME "Gvap"
!define DESCRIPTION "Official Go implementation of the Vapory protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gvap is installed global
