...
// DeployFIFSRegistrar deploys a new Vapory contract, binding an instance of FIFSRegistrar to it.
...
// FIFSRegistrar is an auto generated Go binding around an Vapory contract.
...
// FIFSRegistrarCaller is an auto generated read-only Go binding around an Vapory contract.
type FIFSRegistrarCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarTransactor is an auto generated write-only Go binding around an Vapory contract.
type FIFSRegistrarTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarSession is an auto generated Go binding around an Vapory contract,
...
// FIFSRegistrarCallerSession is an auto generated read-only Go binding around an Vapory contract,
...
// FIFSRegistrarTransactorSession is an auto generated write-only Go binding around an Vapory contract,
...
// FIFSRegistrarRaw is an auto generated low-level Go binding around an Vapory contract.
type FIFSRegistrarRaw struct {
	Contract *FIFSRegistrar // Generic contract binding to access the raw methods on
}

// FIFSRegistrarCallerRaw is an auto generated low-level read-only Go binding around an Vapory contract.
...
// FIFSRegistrarTransactorRaw is an auto generated low-level write-only Go binding around an Vapory contract.
