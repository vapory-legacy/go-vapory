...
// Tests disassembling the instructions for valid vvm code
...
// Tests disassembling the instructions for invalid vvm code
...
// Tests disassembling the instructions for empty vvm code
