...
func makeTestState() (Database, *vapdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := vapdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db vapdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db vapdb.Database, root common.Hash) error {
...
func checkStateConsistency(db vapdb.Database, root common.Hash) error {
