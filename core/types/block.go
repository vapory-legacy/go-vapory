...
// Package types contains data types related to Vapory consensus.
package types
...
// Header represents a block header in the Vapory blockchain.
type Header struct {
...
// Block represents an entire block in the Vapory blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package vap to track
...
// [deprecated by vap/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for vap protocol, etc.
...
// EncodeRLP serializes b into the Vapory RLP block format.
