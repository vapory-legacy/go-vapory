...
func CreateConsensusEngine(ctx *node.ServiceContext, config *vapash.Config, chainConfig *params.ChainConfig, db ethdb.Database) consensus.Engine {
...
func (s *Vapory) ChainDb() ethdb.Database            { return s.chainDb }
