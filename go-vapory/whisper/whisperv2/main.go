...
import (
	...
	"github.com/vaporyco/go-vapory/logger"
	"github.com/vaporyco/go-vapory/p2p"
	"github.com/vaporyco/go-vapory/p2p/nat"
	"github.com/vaporyco/go-vapory/whisper"
)
...
func main() {
	...
	// Create an Vapory peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Vapory peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Vapory peer: %v.\n", err)
		os.Exit(1)
	}
