...
// stateObject represents an Vapory account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of vapory address of the account
	data     Account
	db       *StateDB
...
// Account is the Vapory consensus representation of accounts.
