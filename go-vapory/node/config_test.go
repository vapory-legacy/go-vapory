...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gvap.ipc", false, filepath.Join(os.TempDir(), "gvap.ipc")},
		{"data", "gvap.ipc", false, "data/gvap.ipc"},
		{"data", "./gvap.ipc", false, "./gvap.ipc"},
		{"data", "/gvap.ipc", false, "/gvap.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gvap.ipc", true, `\\.\pipe\gvap.ipc`},
		{"data", "gvap.ipc", true, `\\.\pipe\gvap.ipc`},
		{"data", `\\.\pipe\gvap.ipc`, true, `\\.\pipe\gvap.ipc`},
	}
