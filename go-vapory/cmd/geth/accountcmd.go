...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Vapory presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gvap wallet import /path/to/my/presale.wallet

will prompt for your password and imports your vapor presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Vapory presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gvap wallet [options] /path/to/my/presale.wallet
...
between vapory nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gvap account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    gvap account import [options] <keyfile>
...
func accountCreate(ctx *cli.Context) error {
	cfg := gvapConfig{Node: defaultNodeConfig()}
	// Load config file.
