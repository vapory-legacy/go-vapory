...
// cacheSize returns the size of the vapash verification cache that belongs to a certain
// block number.
...
// datasetSize returns the size of the vapash mining dataset that belongs to a certain
// block number.
