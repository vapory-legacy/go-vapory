...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db vapdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db vapdb.Database) error {
