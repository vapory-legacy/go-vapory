...
// ecrecover extracts the Vapory account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Vapory address
...
// Vapory testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     vapdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Vapory address of the signing key
...
func New(config *params.CliqueConfig, db vapdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Vapory address recovered
