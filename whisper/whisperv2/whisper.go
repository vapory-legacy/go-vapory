...
import (
	...
	"github.com/vaporyco/go-vapory/crypto/ecies"
	"github.com/vaporyco/go-vapory/event/filter"
...
// Whisper represents a dark communication interface through the Vapory
...
// New creates a Whisper client ready to communicate through the Vapory P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
