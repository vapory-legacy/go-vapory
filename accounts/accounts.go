...
// Package accounts implements high level Vapory account management.
package accounts
...
// Account represents an Vapory account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Vapory account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain vapory.ChainStateReader)
