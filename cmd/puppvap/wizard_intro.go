...
// makeWizard creates and returns a new puppvap wizard.
...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppvap, your Vapory private network manager |")
	fmt.Println("|                                                           |")
	...
	fmt.Println("|                                                           |")
	fmt.Println("| Puppvap uses SSH to dial in to remote servers, and builds |")
	...
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppvap", w.network)
