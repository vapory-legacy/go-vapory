...
var bugCommand = cli.Command{
	...
	Name:      "bug",
	Usage:     "opens a window to report a bug on the gvap repo",
	ArgsUsage: " ",
	Category:  "MISCELLANEOUS COMMANDS",
}

const issueUrl = "https://github.com/vaporyco/go-vapory/issues/new"

// reportBug reports a bug by opening a new URL to the go-vapory GH issue
