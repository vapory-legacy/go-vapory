...
func newTestLDB() (*vapdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "vapdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := vapdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db vapdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db vapdb.Database, t *testing.T) {
	const n = 8
